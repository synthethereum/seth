...
// ----------------------------
// HISTORY FOR GRAPH (OPTIONAL, НО ПУСТЬ БУДЕТ)
// ----------------------------
...
function createDuel(p1, p2) {
  ...
  // Сначала говорим фронту, что матч найден
...
async function startRound(duel) {
  ...
  try {
    ...
    // Фоллбек – тупой стоковый вопрос, чтобы игра не ломалась
    q = {
      id: "fallback",
